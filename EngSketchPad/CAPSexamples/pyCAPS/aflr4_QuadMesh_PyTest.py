...
parser = argparse.ArgumentParser(description = 'AFLR4 QuadMesh PyTest Example',
                                 prog = 'aflr4_QuadMesh_PyTest',
...
# Working directory
workDir = os.path.join(str(args.workDir[0]), "AFLR4QuadMeshTest")
...
# Generate quads 
aflr4.input.Mesh_Gen_Input_String = "mquad=1 skin_mode=1"
