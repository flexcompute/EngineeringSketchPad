...
BOOST_AUTO_TEST_CASE( cmath )
{
  ...
  BOOST_CHECK( chkSurrealD4( v1, 1, 1, 2, 3, 4 ) );
  BOOST_CHECK( chkSurrealD4( v2, expm1(1.), d0, 2*d0, 3*d0, 4*d0, tol ) );
  v2 += expm1(v1);  d0 = 2*exp(1.);
  BOOST_CHECK( chkSurrealD4( v1, 1, 1, 2, 3, 4 ) );
  BOOST_CHECK( chkSurrealD4( v2, 2*expm1(1.), d0, 2*d0, 3*d0, 4*d0, tol ) );
  v2 = log(v1);
  BOOST_CHECK( chkSurrealD4( v1, 1, 1, 2, 3, 4 ) );
  ...
  v2 = log1p(v1);  d0 = 1./2.;
  BOOST_CHECK( chkSurrealD4( v1, 1, 1, 2, 3, 4 ) );
  BOOST_CHECK( chkSurrealD4( v2, log(2), d0, 2*d0, 3*d0, 4*d0, tol ) );
  //cppcheck-suppress duplicateExpression
  v2 += log1p(v1);  d0 = 2./2.;
  BOOST_CHECK( chkSurrealD4( v1, 1, 1, 2, 3, 4 ) );
  BOOST_CHECK( chkSurrealD4( v2, 2*log(2), d0, 2*d0, 3*d0, 4*d0, tol ) );
  ...
  BOOST_CHECK( chkSurrealD4( v3, erf(v2.value()), v2.deriv(0)*erf_x, v2.deriv(1)*erf_x, v2.deriv(2)*erf_x, v2.deriv(3)*erf_x) );
  v3 = erfc(v2);
  BOOST_CHECK( chkSurrealD4( v2, 1.5, 1.5, 3, 4.5, 6 ) );
  Real erfc_x = -2./sqrt(M_PI)*exp(-(v2.value()*v2.value()));
  BOOST_CHECK( chkSurrealD4( v3, erfc(v2.value()), v2.deriv(0)*erfc_x, v2.deriv(1)*erfc_x, v2.deriv(2)*erfc_x, v2.deriv(3)*erfc_x) );
