...
int su2_writeCongfig_Harrier_backup(void *aimInfo, capsValue *aimInputs,
                               ...
                               cfdBoundaryConditionStruct bcProps, int withMotion)
{
    ...
    printf("Write SU2 configuration file for version \"Harrier (8.0.0) \"\n");
    stringLength = 1
    ...
    fprintf(fp,"%% File Version 8.0.0 \"Harrier\"                                               %%\n");
    fprintf(fp,"%%                                                                              %%\n");
    ...
    fprintf(fp,"%% \n");
    fprintf(fp,"%% Mass diffusivity model (CONSTANT_DIFFUSIVITY, FLAMELET) \n");
...
fprintf(fp,"%% \n");
    ...
    fprintf(fp,"%% \n");
    fprintf(fp,"%% list of markers species transport and flamelet model where strong boundary conditions should be used \n");
    fprintf(fp,"%% MARKER_SPECIES_STRONG_BC= (inlet, wall)\n");
    fprintf(fp,"\n");
